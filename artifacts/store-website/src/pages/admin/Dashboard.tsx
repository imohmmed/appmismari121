            ...
            <div key={i} className="glass-panel p-6 rounded-2xl relative overflow-hidden group">
              ...
              <div>
                ...
                <p className="text-3xl font-black">
                  {isLoading ? <span className="animate-pulse bg-white/10 w-16 h-8 block rounded-md" /> : stat.value.toLocaleString()}
                </p>
              </div>
            </div>
          ))}
          ...
          <div className="h-[300px] w-full" dir="ltr">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={dummyChartData} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                ...
                <Tooltip 
                  contentStyle={{ backgroundColor: 'hsl(var(--card))', borderColor: 'rgba(255,255,255,0.1)', borderRadius: '12px', direction: 'rtl' }}
