...
const TV_APPS = [
  { id: 1, name: "Netflix", desc: "Stream movies & shows", icon: "film", tag: "modded" },
  ...
  return (
    <View style={[styles.container, { paddingTop: isWeb ? 67 : insets.top }]}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          const tagColor = item.tag === "tweaked" ? Colors.light.tagTweaked : item.tag === "hacked" ? Colors.light.tagHacked : Colors.light.tagModded;
          return (
